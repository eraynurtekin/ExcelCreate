...
namespace ExcelDeneme.Controllers
{
    public class ExcelSampleController : Controller
    {
        ...
        private void CreateFooterRow(int BeginRow, int DataItemCount, Row rw)
        {
            ...
            c.CellReference = "A" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((UInt32)CELLSTYLE_DEFAULT);
            c.CellReference = "B" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((UInt32)CELLSTYLE_DEFAULT);
            c.CellReference = "C" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((UInt32)CELLSTYLE_DEFAULT);
            c.CellReference = "D" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((UInt32)CELLSTYLE_DEFAULT);
            c.CellReference = "E" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((UInt32)CELLSTYLE_DEFAULT);
            c.CellReference = "F" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            Cell QtyCell = c;
            ...
            c.CellReference = "G" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
            Cell UnitPriceCell = c;
            ...
            c.CellReference = "H" + (rw.RowIndex + 5).ToString();
            rw.Append(c);
